...
public class AESHelper {
    ...
    public String DecryptMessage(@NonNull String message,@NonNull PrivateKey privateKey,@NonNull User otherUser,String userId)
        ...
        try {
            ...
            byte[] encryptedKeyBytes = getbytes(messageJsonObject.getJSONObject(MESSAGE_KEYS).getString(userId));
    ...
    public void decryptFile(@NonNull FileInputStream fileInputStream, @NonNull  FileOutputStream fileOutputStream,
                            @NonNull PrivateKey privateKey, @NonNull User otherUser,@NonNull File outFile,@NonNull String cipherText,String userId)
